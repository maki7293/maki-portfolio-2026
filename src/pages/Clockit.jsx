    ...
    >
      ...
      >
        ...
        <div className="st-text-col">
            ...
            {TAGS.map(tag => (
              <span
                ...
                style={{
                  ...
                  color: '#C9AD33', // Clock'it accent color
                  backgroundColor: 'rgba(201, 173, 51, 0.25)', // Lighter version for bg
          ...
          >
            <strong>Clock'it</strong> is an enterprise platform optimizing <strong>administrative workflows.</strong> I developed a role-based
            React dashboard that translates complex backend operations—like real-time attendance and automated
            leave tracking—into a clean, highly efficient user interface.
          </p>
        </div>

        {/* Right: Hero Image (clockit-1) */}
        <div className="st-img-col">
          <img
            src="/assets/clockit-1.png"
            alt="Clock'it App UI Mockup"
            style={{
              width: '100%',
              height: 'auto',
              display: 'block',
      ...
      {/* ── Bottom: Showcase Image (clockit-2) ── */}
      <motion.div 
      ...
      >
        <img
          src="/assets/clockit-2.png"
          alt="Clock'it full UI showcase"
          style={{
            width: '100%',
            height: 'auto',
            display: 'block',
